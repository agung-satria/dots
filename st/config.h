...
static char *font2[] = { "Noto Color Emoji:pixelsize=21:antialias=true:autohint=true" };
...
"#dee1e6",
  ...
  // [257] = "#101419", /* default background colour */
  [257] = "#070707", /* darker */
  [258] = "#dce1fb",
...
static Shortcut shortcuts[] = {
  ...
  { MODKEY,               XK_Page_Up,     kscrollup,      {.i = -1} },
  { MODKEY,               XK_Page_Down,   kscrolldown,    {.i = -1} },
  { MODKEY,		            XK_1,		        changealpha,	  {.f = -0.05} },
  { MODKEY,		            XK_2,		        changealpha,	  {.f = +0.05} },
  { MODKEY,		            XK_3,		        changealpha,	  {.f = +2.00} },
  { MODKEY,               XK_4,           externalpipe,   {.v = copyurlcmd } },
  { MODKEY,               XK_5,           externalpipe,   {.v = openurlcmd } },
  { MODKEY,               XK_6,           externalpipe,   {.v = copyoutput } },
  { TERMMOD,              XK_Up,          zoom,           {.f = +1} },
  { TERMMOD,              XK_Down,        zoom,           {.f = -1} },
